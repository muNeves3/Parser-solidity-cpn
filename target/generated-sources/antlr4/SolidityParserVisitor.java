...
public interface SolidityParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#userDefinableOperator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#usingAliases}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#addressPayable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAddressPayable(SolidityParser.AddressPayableContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code FunctionCallOptions}
	 * labeled alternative in {@link SolidityParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#literalWithSubDenomination}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLiteralWithSubDenomination(SolidityParser.LiteralWithSubDenominationContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#boolLiteral}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBoolLiteral(SolidityParser.BoolLiteralContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#assemblyFlags}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#yulbool}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitYulbool(SolidityParser.YulboolContext ctx);
	/**
